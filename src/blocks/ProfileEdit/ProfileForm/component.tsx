  ...
  return (
    <form className='edit-form' onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="edit-select-block">
        <div className="edit-input-block">
          ...
          <div className='date-block'>
            <div onClick={() => {setDateShow(!dateShow)}}>
              <input readOnly className='edit-text-input' id='birthday' {...register("birthday", { required: true })} value={date? formatDate(date) : ''}/>
              {errors.birthday && <p className='edit-error-description'>{t("edit.form.errorMessage")}</p>}
            </div>

            { dateShow &&
              <Calendar onChange={(value: Date) => {setDate(value)}} value={date}/> //Есть проблемка. Потом решу.
            }
          </div>
      ...
      <div className="edit-input-block">
        ...
        <textarea className='edit-text-input textarea' id='about' {...register("about")}></textarea>
