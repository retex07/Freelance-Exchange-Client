  ...
  return (
    ...
    <section className="announ-section">
      <div className="container announ-container">
        ...
        <AdsComponent name='Имя' theme='Тема проблемы' description={'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam mollitia maiores, nostrum tempora libero ad odit, perferendis praesentium vitae ea eos, perspiciatis expedita beatae numquam! Ea, neque. Fuga, rem modi.'} date="11.11.22"/>
