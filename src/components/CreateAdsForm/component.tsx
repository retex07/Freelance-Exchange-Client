  ...
  return (
    <form className='creare-ads-form' action="" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="creare-ads-input-block">
        <label className='creare-ads-label'>
          {t("adsCreate.category")}
        </label>
      ...
      <div className="creare-ads-input-block">
        <label className='creare-ads-label'>
          {t("adsCreate.description")}
        </label>
        
        <textarea className='creare-ads-text-input create-ads-textarea' id='description' {...register("description", { required: true })} />
      ...
      <div className="creare-ads-input-block price-block">
        ...
        <input type={"number"} className='creare-ads-text-input' id='price' {...register("price", { required: true })} />
